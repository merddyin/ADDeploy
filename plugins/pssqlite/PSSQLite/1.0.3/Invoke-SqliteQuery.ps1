function Invoke-SqliteQuery {
    ...
    Begin
    {
        ...
        if ($PSBoundParameters.ContainsKey('InputFile'))
        {
            ...
            Write-Debug "Extracted query from [$InputFile]"
        }
        Write-Debug "Running Invoke-SQLiteQuery with ParameterSet '$($PSCmdlet.ParameterSetName)'.  Performing query '$Query'"
    ...
    Process
    {
        foreach($DB in $DataSource)
        {
            ...
            else
            {
                ...
                {
                    Write-Debug "Querying existing Data Source '$Database'"
                }
                else
                {
                    Write-Debug "Creating and querying Data Source '$Database'"
                }
